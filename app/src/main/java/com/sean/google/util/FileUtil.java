...
public class FileUtil {
    ...
    public static boolean write(String text, File des) {
        try {
            return write(text, new FileOutputStream(des));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return false;
    ...
    public static boolean write(String text, String des) {
        try {
            return write(text, new FileOutputStream(des));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static boolean write(String text, OutputStream des) {
        try {
            des.write(text.getBytes(StandardCharsets.UTF_8));
            return true;
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
