...
import org.sean.mlbook.common.api.ILingdiankanshuApi;
import org.sean.mlbook.listener.OnGetChapterListListener;
import org.sean.mlbook.model.IStationBookModel;
...
public class LingdiankanshuStationBookModelImpl extends MBaseModelImpl implements IStationBookModel {
    ...
    public Observable<List<SearchBookBean>> searchBook(String content, int page) {
        return getRetrofitObject("https://ziyuan.baidu.com/").create(ILingdiankanshuApi.class).searchBook(content, page - 1, "16865089933227718744").flatMap(new Function<String, ObservableSource<List<SearchBookBean>>>() {
            @Override
