...
public class TxtSkyBookModelImpl extends MBaseModelImpl implements IGxwztvBookModel {
    public static final String TAG = "https://www.xstt5.com";

    public static TxtSkyBookModelImpl getInstance() {
        return new TxtSkyBookModelImpl();
    }
...
//        index_4.html
        ...
        return getRetrofitObject(TxtSkyBookModelImpl.TAG).create(IGxwztvApi.class).getKindBooks(url.replace(TxtSkyBookModelImpl.TAG, "")).flatMap(new Function<String, ObservableSource<List<SearchBookBean>>>() {
            @Override
            public ObservableSource<List<SearchBookBean>> apply(String s) throws Exception {
                return analySearchBook(s);
            }
